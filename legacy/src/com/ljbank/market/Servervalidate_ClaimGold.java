...
/*存款业绩认领比例校验*/
public class Servervalidate_ClaimGold {
	...
	public static boolean isClaimRatio(ReportRequest rrequest, String RATIO, Map<String, String> mValues, List<String> lstErrorMessages) throws SQLException {
		...
		String txn_run_nbr = rrequest.getStringAttribute("TXN_RUN_NBR", "");
		...
		try {
			String sql = "SELECT 100-SUM(CASE WHEN EMP_ID<>'000000'  and CLAIM_STATUS_ID in ('1','2','5','6') THEN ratio ELSE 0 END) AS inratio FROM IBS.GOLD_EMP_RELA WHERE TXN_RUN_NBR=? with ur" 
				;

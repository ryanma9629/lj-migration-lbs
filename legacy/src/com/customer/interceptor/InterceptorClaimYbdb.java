...
/*存款认领校验页面*/
public class InterceptorClaimYbdb extends AbsInterceptorDefaultAdapter {

	@Override
	public void doStart(ReportRequest rrequest, ReportBean rbean) {
		String insure_no = rrequest.getStringAttribute("INSURE_NO", "");// 取出凭证号
		...
		if (insure_no.equals("")) {
			...
			try {
				String SQL_BUTTON = "select count(1) as cnt from IBS.T1_YBDB_EMP_RELA where INSURE_NO=? ";

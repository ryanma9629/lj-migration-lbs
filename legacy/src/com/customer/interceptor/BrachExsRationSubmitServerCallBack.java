...
public class BrachExsRationSubmitServerCallBack implements IServerAction {
		...
		if (lstData == null || lstData.size() == 0) {
			...
			for (Map<String, String> mParams : lstData) {
				...
				try {
					...
					String sqlSub ="UPDATE IBS.T3_BRANCH_EXS_RATIO SET STUS='1' ,MODIFY_PEOPLE=? ,MODIFY_TIME=? ,MODIFY_IP=? " +
							"WHERE EXAM_YEAR=? AND EXAM_Q=? AND BRANCH_ORG_ID=? and STUS in ('0','2') " ;

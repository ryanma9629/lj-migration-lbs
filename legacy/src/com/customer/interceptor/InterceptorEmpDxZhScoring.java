...
public class InterceptorEmpDxZhScoring extends AbsInterceptorDefaultAdapter {
	@Override
	public void beforeDisplayReportDataPerRow(ReportRequest rrequest,
		...
		if (reportTypeObj.getLstReportData() != null
			...
			if (!"0".equals((rowDataBean.getColData("STUS"))) && !"-1".equals((rowDataBean.getColData("STUS")))) {

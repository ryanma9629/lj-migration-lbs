...
/*存款认领校验页面*/
public class InterceptorClaimDep_OLD extends AbsInterceptorDefaultAdapter {
	...
	public void doStart(ReportRequest rrequest, ReportBean rbean) {
		...
		if (vuch_nbr.equals("")) {
			...
			try {
				// SQL是否存在输入的凭证号 ，其中VUCH_TYPE_ID,VUCH_TYPE_NM
				/*		
				 * VUCH_TYPE_ID,VUCH_TYPE_NM
					...
					18,活期一本通
				 */
				String SQL = "Select count(1) as cnt from IBS.T1_VUCH_DETAIL where VUCH_NBR=? and  VUCH_TYPE_ID in ('10','11','12','13','14','15','16','17','18')";
...
//						String VUCH_TYPE_NM="";//获取凭证类型
						...
						while (resultSet1.next()) {
							...
							VUCH_ORG_ID=resultSet1.getString("ORG_ID");
//							VUCH_TYPE_NM=resultSet1.getString("VUCH_TYPE_NM");
							VUCH_ORG_NM=resultSet1.getString("ORG_NM");
							
							VUCH_CST_NM=resultSet1.getString("CST_NM");
							BIZ_TYPE_NM=resultSet1.getString("BIZ_TYPE_NM");
							VUCH_STATUS_NM=resultSet1.getString("VUCH_STATUS_NM");
							OPEN_DT=resultSet1.getString("OPEN_DT");   
							
							System.out.println("获取凭证所属机构号码为："+VUCH_ORG_ID);
							if (resultSet1.getString("WITH_CARD_F").equals("1")) {
								// 只能对卡进行认领
								rrequest.authorize("dtl", null, null, "display", "false");
								rrequest.authorize("other_dtl", null, null, "display", "false");
								...
								// 无配卡
								/************************** step4 判断输入的凭证号否存在他人认领信息 *************************************************/
								// SQL_Other是否存在输入的凭证号的他人认领信息

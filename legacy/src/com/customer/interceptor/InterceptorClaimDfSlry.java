...
/*代发工资认领校验页面*/
public class InterceptorClaimDfSlry extends AbsInterceptorDefaultAdapter {

	@Override
	public void doStart(ReportRequest rrequest, ReportBean rbean) {
		String ent_nm = rrequest.getStringAttribute("ENT_NM", "");// 取出凭证号
		String ent_id = rrequest.getStringAttribute("ENT_ID", "");// 取出企业编号
...
//		String usr_org_nm = (String) rrequest.getRequest().getSession().getAttribute("usr_org_nm");
		...
		if (ent_nm.equals("") && ent_id.equals("")) {
		...
		/*
			...
			try {
				String SQL_BUTTON = "select count(1) as cnt from IBS.T1_DF_SLRY_EMP_RELA where ENT_NM=? ";

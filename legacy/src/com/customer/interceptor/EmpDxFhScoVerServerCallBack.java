...
public class EmpDxFhScoVerServerCallBack implements IServerAction {
		...
		if (lstData == null || lstData.size() == 0) {
			...
			for (Map<String, String> mParams : lstData) {
				...
				try {
					...
					String sqlSub ="UPDATE IBS.T2_EMP_DX_SCORE SET STUS='4' ,VERIFY_PEOPLE=? ,VERIFY_TIME=? ,VERIFY_IP=?" +
							"WHERE MSR_PRD_DT=? and EMP_ID=? " ;

...
public class InterceptorBrachExsRationMod extends AbsInterceptorDefaultAdapter {
	@Override
	public void beforeDisplayReportDataPerRow(ReportRequest rrequest,
		...
		if (reportTypeObj.getLstReportData() != null
			...
			if ("分行有权人审核通过".equals((rowDataBean.getColData("STUS"))) || "已提交分行有权人".equals((rowDataBean.getColData("STUS")))) {
				rowDataBean.setReadonly(true);
			}
			if(!"分行有权人审核通过".equals((rowDataBean.getColData("STUS"))) )
            {

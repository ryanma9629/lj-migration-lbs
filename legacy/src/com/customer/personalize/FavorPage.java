...
public class FavorPage implements IServerAction {
	...
	public void favorPageId(HttpServletRequest request, HttpServletResponse response, String pageid, String user_id) {
		...
		String sql = " select * from cst.sys_c_per_fvor where user_id= ? and page_id=? and service_id='060'";
		String insertSql = "insert into cst.sys_c_per_fvor(user_id,page_id,service_id) values(?,?,'060')";
		String deletSql = " delete from cst.sys_c_per_fvor where user_id= ? and page_id=? and service_id='060'";
		try {

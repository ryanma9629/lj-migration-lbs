...
public class ChangePassword extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) {
		try {
			...
			String sql = " select user_id,user_name,password,is_enable from cst.sys_c_sec_user where user_id= ? and password=? ";
			String updateSql="update cst.sys_c_sec_user set password=?  where user_id=? ";
